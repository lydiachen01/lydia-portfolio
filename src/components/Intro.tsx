    ...
    return (
        <div className="p-[15vw] space-y-1">
            ...
            <div className="flex items-center pt-2">
                <a href="https://github.com/lydiachen01" target="_blank"><img src="github_black.png" className="cursor-pointer h-[2.5vh] mr-3"></img></a>
                <a href="https://www.linkedin.com/in/lydia-chen-tufts/" target="_blank"><img src="linkedin_black.png" className="h-[80%] hover:opacity-100 cursor-pointer h-[1.9vh]"></img></a>
            </div>
