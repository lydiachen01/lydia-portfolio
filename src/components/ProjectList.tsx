...
const ProjectList: React.FC<Project> = ({title, description, year, route}) => {
    ...
    return (
        <a href={route} className="relative">
            <div className='relative' 
            onMouseEnter={handleHoverEnter}
            onMouseLeave={handleHoverLeave}>
                <span
                        // Adding hover: p-4 looks cool
                        className='absolute py-4 lg:max-w-[40vw] max-w-[90vw] border \
                ...
                <div className="relative flex border rounded-xl lg:max-w-[40vw] \
                max-w-[90vw] p-4 px-6 mb-4 \
                cursor-pointer hover:text-white">
                    <label className="cursor-pointer w-[18vw] mr-8">{title}</label>
